    ...
    const handleSavePurchases = async () => {
        try {
            ...
            const existingRegistrations = JSON.parse(
                localStorage.getItem('uciTourRegistrations') || '[]'
            );
            existingRegistrations.push(registration);
            localStorage.setItem('uciTourRegistrations', JSON.stringify(existingRegistrations));
    ...
    return (
        <>
            ...
            <header data-aos="zoom-in" data-aos-duration="600">
                <h1 className="tours-header">UCI Tour</h1>
            </header>
